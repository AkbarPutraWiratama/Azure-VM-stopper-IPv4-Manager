...
# ============================================================
# Azure VM + TigerVNC + 9Router - SSH Only
# ============================================================
...
case "${1:-}" in
    start)
        ...
        echo
        echo "Combined tunnel:"
        echo "ssh -L ${VNC_PORT}:127.0.0.1:${VNC_PORT} -L ${ROUTER_PORT}:127.0.0.1:${ROUTER_PORT} ${SSH_USER}@${IP}"

        echo
        echo "After connecting:"
        echo "TigerVNC : 127.0.0.1:${VNC_PORT}"
        echo "9Router  : http://127.0.0.1:${ROUTER_PORT}"
        echo "API Base : http://127.0.0.1:${ROUTER_PORT}/v1"
